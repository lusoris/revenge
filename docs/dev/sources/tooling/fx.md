...
[View Source](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L45)

    const DefaultTimeout = 15 * [time](/time).[Second](/time#Second)
...
[View Source](https://github.com/uber-go/fx/blob/v1.24.0/version.go#L24)
...
[View Source](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L264)

    var NopLogger = WithLogger(func() [fxevent](/go.uber.org/fx@v1.24.0/fxevent).[Logger](/go.uber.org/fx@v1.24.0/fxevent#Logger) { return [fxevent](/go.uber.org/fx@v1.24.0/fxevent).[NopLogger](/go.uber.org/fx@v1.24.0/fxevent#NopLogger) })
...
[View Source](https://github.com/uber-go/fx/blob/v1.24.0/provide.go#L112)

    var Private = privateOption{}

Private is an option that can be passed as an argument to Provide or Supply to restrict access to the constructors being provided. Specifically, corresponding constructors can only be used within the current module or modules the current module contains. Other modules that contain this module won't be able to use the constructor.
...
#### func [Annotate](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1901) ¶ added in v1.15.0
...
#### func [Self](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1288) ¶ added in v1.22.0

    func Self() [any](/builtin#any)

Self returns a special value that can be passed to As to indicate that a type should be provided as its original type, in addition to whatever other types it gets provided as via other As annotations.
...
in that it provides the same *bytes.Buffer instance as both a*bytes.Buffer and an io.Writer.

#### func [ValidateApp](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L412) ¶ added in v1.13.0

    func ValidateApp(opts ...Option) [error](/builtin#error)
...
#### func [VisualizeError](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L557) ¶ added in v1.7.0

    func VisualizeError(err [error](/builtin#error)) ([string](/builtin#string), [error](/builtin#error))
...
#### type [Annotated](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L63) ¶ added in v1.9.0
...
#### func (Annotated) [String](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L85) ¶ added in v1.10.0

    func (a Annotated) String() [string](/builtin#string)

#### type [Annotation](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L117) ¶ added in v1.15.0
...
#### func [As](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1259) ¶ added in v1.15.0
...
As entirely replaces the default return types of a function. In order to maintain the original return types when using As, see Self.

As annotation cannot be used in a function that returns an Out struct as a return type.

#### func [From](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1486) ¶ added in v1.19.0
...
#### func [OnStart](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1115) ¶ added in v1.18.0
...
#### func [OnStop](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L1179) ¶ added in v1.18.0
...
#### func [ParamTags](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L352) ¶ added in v1.15.0

    func ParamTags(tags ...[string](/builtin#string)) Annotation
...
#### func [ResultTags](https://github.com/uber-go/fx/blob/v1.24.0/annotated.go#L542) ¶ added in v1.15.0

    func ResultTags(tags ...[string](/builtin#string)) Annotation
...
#### type [App](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L300) ¶
...
#### func [New](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L422) ¶
...
#### func (*App) [Done](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L741) ¶

    func (app *App) Done() <-chan [os](/os).[Signal](/os#Signal)
...
#### func (*App) [Err](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L634) ¶

    func (app *App) Err() [error](/builtin#error)
...
#### func (*App) [Run](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L596) ¶
...
After the application has started, it can be shut down by sending a signal or calling [Shutdowner.Shutdown]. On successful shutdown, whether initiated by a signal or by the user, Run will return to the caller, allowing it to exit cleanly. Run will exit with a non-zero status code if startup or shutdown operations fail, or if the Shutdowner supplied a non-zero exit code.

#### func (*App) [Start](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L660) ¶

    func (app *App) Start(ctx [context](/context).[Context](/context#Context)) (err [error](/builtin#error))
...
#### func (*App) [StartTimeout](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L760) ¶ added in v1.5.0

    func (app *App) StartTimeout() [time](/time).[Duration](/time#Duration)
...
#### func (*App) [Stop](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L716) ¶

    func (app *App) Stop(ctx [context](/context).[Context](/context#Context)) (err [error](/builtin#error))
...
#### func (*App) [StopTimeout](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L767) ¶ added in v1.5.0

    func (app *App) StopTimeout() [time](/time).[Duration](/time#Duration)
...
#### func (*App) [Wait](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L752) ¶ added in v1.19.0
...
#### type [DotGraph](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L535) ¶ added in v1.7.0

    type DotGraph [string](/builtin#string)
...
#### type [ErrorHandler](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L353) ¶ added in v1.7.0

    type ErrorHandler interface {
     HandleError([error](/builtin#error))
    }
...
#### type [Hook](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L45) ¶

    type Hook struct {
     OnStart func([context](/context).[Context](/context#Context)) [error](/builtin#error)
     OnStop  func([context](/context).[Context](/context#Context)) [error](/builtin#error)
     // contains filtered or unexported fields
    }
...
#### func [StartHook](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L77) ¶ added in v1.19.0
...
#### func [StartStopHook](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L122) ¶ added in v1.19.0
...
#### func [StopHook](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L110) ¶ added in v1.19.0
...
#### type [HookFunc](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L30) ¶ added in v1.19.0

    type HookFunc interface {
     ~func() | ~func() [error](/builtin#error) | ~func([context](/context).[Context](/context#Context)) | ~func([context](/context).[Context](/context#Context)) [error](/builtin#error)
    }

A HookFunc is a function that can be used as a Hook.

#### type [In](https://github.com/uber-go/fx/blob/v1.24.0/inout.go#L33) ¶

    type In = [dig](/go.uber.org/dig).[In](/go.uber.org/dig#In)
...
#### type [Lifecycle](https://github.com/uber-go/fx/blob/v1.24.0/lifecycle.go#L37) ¶
...
#### type [Option](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L56) ¶
...
#### func [Decorate](https://github.com/uber-go/fx/blob/v1.24.0/decorate.go#L178) ¶ added in v1.17.0
...
#### func [Error](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L68) ¶ added in v1.6.0

    func Error(errs ...[error](/builtin#error)) Option
...
#### func [ErrorHook](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L360) ¶ added in v1.7.0
...
#### func [Extract](https://github.com/uber-go/fx/blob/v1.24.0/extract.go#L37) deprecated
...
#### func [Invoke](https://github.com/uber-go/fx/blob/v1.24.0/invoke.go#L64) ¶
...
#### func [Logger](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L239) ¶
...
#### func [Module](https://github.com/uber-go/fx/blob/v1.24.0/module.go#L78) ¶ added in v1.17.0

    func Module(name [string](/builtin#string), opts ...Option) Option
...
#### func [Options](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L93) ¶
...
#### func [Populate](https://github.com/uber-go/fx/blob/v1.24.0/populate.go#L64) ¶ added in v1.4.0
...
#### func [Provide](https://github.com/uber-go/fx/blob/v1.24.0/provide.go#L64) ¶
...
#### func [RecoverFromPanics](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L164) ¶ added in v1.19.0
...
#### func [Replace](https://github.com/uber-go/fx/blob/v1.24.0/replace.go#L77) ¶ added in v1.17.0
...
#### func [StartTimeout](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L118) ¶ added in v1.5.0

    func StartTimeout(v [time](/time).[Duration](/time#Duration)) Option
...
#### func [StopTimeout](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L142) ¶ added in v1.5.0

    func StopTimeout(v [time](/time).[Duration](/time#Duration)) Option
...
#### func [Supply](https://github.com/uber-go/fx/blob/v1.24.0/supply.go#L82) ¶ added in v1.12.0
...
#### func [WithLogger](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L204) ¶ added in v1.14.0

    func WithLogger(constructor interface{}) Option

WithLogger specifies the [fxevent.Logger](/go.uber.org/fx@v1.24.0/fxevent#Logger) used by Fx to log its own events (e.g. a constructor was provided, a function was invoked, etc.).
...
If Fx fails to build the logger, or no logger is specified, it will fall back to [fxevent.ConsoleLogger](/go.uber.org/fx@v1.24.0/fxevent#ConsoleLogger) configured to write to stderr.

#### type [Out](https://github.com/uber-go/fx/blob/v1.24.0/inout.go#L43) ¶

    type Out = [dig](/go.uber.org/dig).[Out](/go.uber.org/dig#Out)
...
#### type [Printer](https://github.com/uber-go/fx/blob/v1.24.0/app.go#L232) ¶

    type Printer interface {
     Printf([string](/builtin#string), ...interface{})
    }
...
Note, this will be deprecated in a future release. Prefer to use [fxevent.Logger](/go.uber.org/fx@v1.24.0/fxevent#Logger) instead.

#### type [ShutdownOption](https://github.com/uber-go/fx/blob/v1.24.0/shutdown.go#L37) ¶ added in v1.9.0
...
#### func [ExitCode](https://github.com/uber-go/fx/blob/v1.24.0/shutdown.go#L53) ¶ added in v1.19.0

    func ExitCode(code [int](/builtin#int)) ShutdownOption
...
#### func [ShutdownTimeout](https://github.com/uber-go/fx/blob/v1.24.0/shutdown.go#L69) deprecated added in v1.19.0

    func ShutdownTimeout(timeout [time](/time).[Duration](/time#Duration)) ShutdownOption
...
#### type [ShutdownSignal](https://github.com/uber-go/fx/blob/v1.24.0/signal.go#L37) ¶ added in v1.19.0

    type ShutdownSignal struct {
     Signal   [os](/os).[Signal](/os#Signal)
     ExitCode [int](/builtin#int)
    }
...
#### func (ShutdownSignal) [String](https://github.com/uber-go/fx/blob/v1.24.0/signal.go#L43) ¶ added in v1.19.0

    func (sig ShutdownSignal) String() [string](/builtin#string)

String will render a ShutdownSignal type as a string suitable for printing.

#### type [Shutdowner](https://github.com/uber-go/fx/blob/v1.24.0/shutdown.go#L31) ¶ added in v1.9.0

    type Shutdowner interface {
     Shutdown(...ShutdownOption) [error](/builtin#error)
    }
