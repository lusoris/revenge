...
> Fetched: 2026-01-30T23:49:03.371313+00:00
> Content-Hash: 7b4a3f225b951ef8
> Type: html
...
("fsnotify: can't remove non-existent watch")
...
("fsnotify: watcher already closed")
...
you're hitting "queue or buffer overflow" errors (
...
for a
full description, and check them with
...
for a version that allows adding options.
...
, but allows adding options. When using Add()
...
sets the buffer size for the Windows backend; no-op on
...
Removing a path that has not yet been added returns
...
WatchList returns all paths explicitly added with
