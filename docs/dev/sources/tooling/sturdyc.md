...
> Fetched: 2026-01-30T23:48:48.982305+00:00
> Content-Hash: 9be98075996c3502
> Type: html
...
("sturdyc: the record has been marked as missing in the cache")
...
("sturdyc: failed to fetch the records that were not in the cache")
...
[T]) PermutatedBatchKeyFn(prefix

string

, permutationStruct interface{})
...
ObserveCacheSize(callback func()
...
WithDistributedMetrics

¶

func WithDistributedMetrics(metricsRecorder
...
WithDistributedStorage

¶

func WithDistributedStorage(storage
...
WithDistributedStorageEarlyRefreshes

¶

func WithDistributedStorageEarlyRefreshes(storage
...
func WithEarlyRefreshes(minAsyncRefreshTime, maxAsyncRefreshTime, syncRefreshTime, retryBaseDelay
...
WithEvictionInterval

¶

func WithEvictionInterval(interval
...
func WithRefreshCoalescing(bufferSize
...
WithRelativeTimeKeyFormat

¶

func WithRelativeTimeKeyFormat(truncation
