...
[View Source](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=22)
    
    
    const Inf = Limit([math](/math).[MaxFloat64](/math#MaxFloat64))

Inf is the infinite rate limit; it allows all events (even if burst is zero). 

[View Source](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=144)
    
    
    const InfDuration = [time](/time).[Duration](/time#Duration)([math](/math).[MaxInt64](/math#MaxInt64))
...
####  type [Limit](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=19) ¶
    
    
    type Limit [float64](/builtin#float64)
...
####  func [Every](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=25) ¶
    
    
    func Every(interval [time](/time).[Duration](/time#Duration)) Limit

Every converts a minimum time interval between events to a Limit. 

####  type [Limiter](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=57) ¶
...
####  func [NewLimiter](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=100) ¶
    
    
    func NewLimiter(r Limit, b [int](/builtin#int)) *Limiter

NewLimiter returns a new Limiter that allows events up to rate r and permits bursts of at most b tokens. 

####  func (*Limiter) [Allow](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=109) ¶
    
    
    func (lim *Limiter) Allow() [bool](/builtin#bool)

Allow reports whether an event may happen now. 

####  func (*Limiter) [AllowN](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=116) ¶
    
    
    func (lim *Limiter) AllowN(t [time](/time).[Time](/time#Time), n [int](/builtin#int)) [bool](/builtin#bool)
...
####  func (*Limiter) [Burst](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=79) ¶
    
    
    func (lim *Limiter) Burst() [int](/builtin#int)
...
####  func (*Limiter) [Limit](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=69) ¶
...
####  func (*Limiter) [Reserve](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=207) ¶
...
####  func (*Limiter) [ReserveN](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=227) ¶
    
    
    func (lim *Limiter) ReserveN(t [time](/time).[Time](/time#Time), n [int](/builtin#int)) *Reservation
...
####  func (*Limiter) [SetBurst](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=318) ¶
    
    
    func (lim *Limiter) SetBurst(newBurst [int](/builtin#int))

SetBurst is shorthand for SetBurstAt(time.Now(), newBurst). 

####  func (*Limiter) [SetBurstAt](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=323) ¶
    
    
    func (lim *Limiter) SetBurstAt(t [time](/time).[Time](/time#Time), newBurst [int](/builtin#int))

SetBurstAt sets a new burst size for the limiter. 

####  func (*Limiter) [SetLimit](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=299) ¶
...
####  func (*Limiter) [SetLimitAt](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=306) ¶
    
    
    func (lim *Limiter) SetLimitAt(t [time](/time).[Time](/time#Time), newLimit Limit)
...
####  func (*Limiter) [Tokens](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=94) ¶
    
    
    func (lim *Limiter) Tokens() [float64](/builtin#float64)

Tokens returns the number of tokens available now. 

####  func (*Limiter) [TokensAt](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=86) ¶
    
    
    func (lim *Limiter) TokensAt(t [time](/time).[Time](/time#Time)) [float64](/builtin#float64)

TokensAt returns the number of tokens available at time t. 

####  func (*Limiter) [Wait](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=233) ¶
    
    
    func (lim *Limiter) Wait(ctx [context](/context).[Context](/context#Context)) (err [error](/builtin#error))

Wait is shorthand for WaitN(ctx, 1). 

####  func (*Limiter) [WaitN](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=241) ¶
    
    
    func (lim *Limiter) WaitN(ctx [context](/context).[Context](/context#Context), n [int](/builtin#int)) (err [error](/builtin#error))
...
####  type [Reservation](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=122) ¶
...
####  func (*Reservation) [Cancel](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=162) ¶
...
####  func (*Reservation) [CancelAt](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=169) ¶
    
    
    func (r *Reservation) CancelAt(t [time](/time).[Time](/time#Time))
...
####  func (*Reservation) [Delay](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=139) ¶
    
    
    func (r *Reservation) Delay() [time](/time).[Duration](/time#Duration)

Delay is shorthand for DelayFrom(time.Now()). 

####  func (*Reservation) [DelayFrom](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=150) ¶
    
    
    func (r *Reservation) DelayFrom(t [time](/time).[Time](/time#Time)) [time](/time).[Duration](/time#Duration)
...
####  func (*Reservation) [OK](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/rate.go;l=134) ¶
    
    
    func (r *Reservation) OK() [bool](/builtin#bool)
...
####  type [Sometimes](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/sometimes.go;l=22) ¶ added in v0.2.0
    
    
    type Sometimes struct {
    	First    [int](/builtin#int)           // if non-zero, the first N calls to Do will run f.
    	Every    [int](/builtin#int)           // if non-zero, every Nth call to Do will run f.
    	Interval [time](/time).[Duration](/time#Duration) // if non-zero and Interval has elapsed since f's last run, Do will run f.
    	// contains filtered or unexported fields
    }
...
####  func (*Sometimes) [Do](https://cs.opensource.google/go/x/time/+/v0.14.0:rate/sometimes.go;l=56) ¶ added in v0.2.0
