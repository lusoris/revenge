...
Package websocket implements the [RFC 6455](https://rfc-editor.org/rfc/rfc6455.html) WebSocket protocol.
...
[View Source](https://github.com/coder/websocket/blob/v1.8.14/errors.go#L8)

    var ErrMessageTooBig = [errors](/errors).[New](/errors#New)("websocket: message too big")

ErrMessageTooBig is returned when a message exceeds the read limit.

### Functions ¶

#### func [NetConn](https://github.com/coder/websocket/blob/v1.8.14/netconn.go#L48) ¶

    func NetConn(ctx [context](/context).[Context](/context#Context), c *Conn, msgType MessageType) [net](/net).[Conn](/net#Conn)
...
#### type [AcceptOptions](https://github.com/coder/websocket/blob/v1.8.14/accept.go#L24) ¶

    type AcceptOptions struct {
     // Subprotocols lists the WebSocket subprotocols that Accept will negotiate with the client.
     // The empty subprotocol will always be negotiated as per [RFC 6455](https://rfc-editor.org/rfc/rfc6455.html). If you would like to
     // reject it, close the connection when c.Subprotocol() == "".
     Subprotocols [][string](/builtin#string)
     ...
     InsecureSkipVerify [bool](/builtin#bool)
     ...
     OriginPatterns [][string](/builtin#string)
     ...
     CompressionThreshold [int](/builtin#int)
     ...
     OnPingReceived func(ctx [context](/context).[Context](/context#Context), payload [][byte](/builtin#byte)) [bool](/builtin#bool)
     ...
     OnPongReceived func(ctx [context](/context).[Context](/context#Context), payload [][byte](/builtin#byte))
    }

AcceptOptions represents Accept's options.

#### type [CloseError](https://github.com/coder/websocket/blob/v1.8.14/close.go#L65) ¶
...
#### func (CloseError) [Error](https://github.com/coder/websocket/blob/v1.8.14/close.go#L70) ¶

    func (ce CloseError) Error() [string](/builtin#string)

#### type [CompressionMode](https://github.com/coder/websocket/blob/v1.8.14/compress.go#L17) ¶

    type CompressionMode [int](/builtin#int)
...
Compression is only used if the peer supports the mode selected.
    ...
    const (
     ...
     CompressionDisabled CompressionMode = [iota](/builtin#iota)
...
#### type [Conn](https://github.com/coder/websocket/blob/v1.8.14/conn.go#L43) ¶
...
#### func [Accept](https://github.com/coder/websocket/blob/v1.8.14/accept.go#L102) ¶

    func Accept(w [http](/net/http).[ResponseWriter](/net/http#ResponseWriter), r *[http](/net/http).[Request](/net/http#Request), opts *AcceptOptions) (*Conn, [error](/builtin#error))
...
#### func [Dial](https://github.com/coder/websocket/blob/v1.8.14/dial.go#L120) ¶

    func Dial(ctx [context](/context).[Context](/context#Context), u [string](/builtin#string), opts *DialOptions) (*Conn, *[http](/net/http).[Response](/net/http#Response), [error](/builtin#error))
...
#### func (*Conn) [Close](https://github.com/coder/websocket/blob/v1.8.14/close.go#L99) ¶

    func (c *Conn) Close(code StatusCode, reason [string](/builtin#string)) (err [error](/builtin#error))
...
#### func (*Conn) [CloseNow](https://github.com/coder/websocket/blob/v1.8.14/close.go#L132) ¶

    func (c *Conn) CloseNow() (err [error](/builtin#error))
...
#### func (*Conn) [CloseRead](https://github.com/coder/websocket/blob/v1.8.14/read.go#L64) ¶

    func (c *Conn) CloseRead(ctx [context](/context).[Context](/context#Context)) [context](/context).[Context](/context#Context)
...
#### func (*Conn) [Ping](https://github.com/coder/websocket/blob/v1.8.14/conn.go#L213) ¶
...
#### func (*Conn) [Read](https://github.com/coder/websocket/blob/v1.8.14/read.go#L41) ¶

    func (c *Conn) Read(ctx [context](/context).[Context](/context#Context)) (MessageType, [][byte](/builtin#byte), [error](/builtin#error))

Read is a convenience method around Reader to read a single message from the connection.

#### func (*Conn) [Reader](https://github.com/coder/websocket/blob/v1.8.14/read.go#L35) ¶

    func (c *Conn) Reader(ctx [context](/context).[Context](/context#Context)) (MessageType, [io](/io).[Reader](/io#Reader), [error](/builtin#error))
...
#### func (*Conn) [SetReadLimit](https://github.com/coder/websocket/blob/v1.8.14/read.go#L97) ¶

    func (c *Conn) SetReadLimit(n [int64](/builtin#int64))
...
#### func (*Conn) [Subprotocol](https://github.com/coder/websocket/blob/v1.8.14/conn.go#L147) ¶

    func (c *Conn) Subprotocol() [string](/builtin#string)

Subprotocol returns the negotiated subprotocol. An empty string means the default protocol.

#### func (*Conn) [Write](https://github.com/coder/websocket/blob/v1.8.14/write.go#L42) ¶

    func (c *Conn) Write(ctx [context](/context).[Context](/context#Context), typ MessageType, p [][byte](/builtin#byte)) [error](/builtin#error)
...
#### func (*Conn) [Writer](https://github.com/coder/websocket/blob/v1.8.14/write.go#L28) ¶

    func (c *Conn) Writer(ctx [context](/context).[Context](/context#Context), typ MessageType) ([io](/io).[WriteCloser](/io#WriteCloser), [error](/builtin#error))
...
#### type [DialOptions](https://github.com/coder/websocket/blob/v1.8.14/dial.go#L23) ¶
    ...
    type DialOptions struct {
     ...
     HTTPHeader [http](/net/http).[Header](/net/http#Header)
...
#### type [MessageType](https://github.com/coder/websocket/blob/v1.8.14/conn.go#L19) ¶

    type MessageType [int](/builtin#int)

MessageType represents the type of a WebSocket message. See <https://tools.ietf.org/html/rfc6455#section-5.6>

    const (
     // MessageText is for UTF-8 encoded text messages like JSON.
     MessageText MessageType = [iota](/builtin#iota) + 1
...
#### func (MessageType) [String](https://github.com/coder/websocket/blob/v1.8.14/stringer.go#L52) ¶

    func (i MessageType) String() [string](/builtin#string)

#### type [StatusCode](https://github.com/coder/websocket/blob/v1.8.14/close.go#L18) ¶

    type StatusCode [int](/builtin#int)
...
#### func [CloseStatus](https://github.com/coder/websocket/blob/v1.8.14/close.go#L78) ¶

    func CloseStatus(err [error](/builtin#error)) StatusCode
...
#### func (StatusCode) [String](https://github.com/coder/websocket/blob/v1.8.14/stringer.go#L85) ¶

    func (i StatusCode) String() [string](/builtin#string)
