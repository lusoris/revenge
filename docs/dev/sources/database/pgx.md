...
> Fetched: 2026-01-30T23:50:08.965736+00:00
> Content-Hash: 8e5d3fcd74bd29d6
> Type: html
...
The primary way of establishing a connection is with
...
and modified before establishing the
connection with

ConnectConfig

to configure settings such as tracing that cannot be configured with a connection
string.
...
represents a single connection to the database and is not concurrency safe. Use package
...
func RowToAddrOfStructByName[T
...
func RowToAddrOfStructByNameLax[T
...
ParseConfig creates a ConnConfig from a connection string. ParseConfig handles all options that
...
func ParseConfigWithOptions(connString
...
func CopyFromFunc(nxtf func() (row []
...
QueryResultFormatsByOID

¶

type QueryResultFormatsByOID map[
...
RowsFromResultReader

¶

func RowsFromResultReader(typeMap *
