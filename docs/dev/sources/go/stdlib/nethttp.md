...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/method.go;l=10)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/status.go;l=9)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=931)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=60)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=1007)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=525)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=58)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=39)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=239)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=109)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2624)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=1909)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transfer.go;l=829)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3826)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transfer.go;l=31)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=41)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=442)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=131)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=207)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3421)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=856)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=493)
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=177)
    
    
    var NoBody = noBody{}

NoBody is an [io.ReadCloser](/io#ReadCloser) with no bytes. Read always returns EOF and Close always returns nil. It can be used in an outgoing client request to explicitly signal that a request has zero bytes. An alternative, however, is to simply set [Request.Body] to nil. 

### Functions ¶

####  func [CanonicalHeaderKey](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=234) ¶
...
####  func [DetectContentType](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/sniff.go;l=21) ¶
...
####  func [Error](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2337) ¶
    
    
    func Error(w ResponseWriter, error [string](/builtin#string), code [int](/builtin#int))
...
####  func [Handle](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2891) ¶
    
    
    func Handle(pattern [string](/builtin#string), handler Handler)
...
####  func [HandleFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2901) ¶
    
    
    func HandleFunc(pattern [string](/builtin#string), handler func(ResponseWriter, *Request))
...
####  func [ListenAndServe](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3702) ¶
    
    
    func ListenAndServe(addr [string](/builtin#string), handler Handler) [error](/builtin#error)
...
####  func [ListenAndServeTLS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3712) ¶
    
    
    func ListenAndServeTLS(addr, certFile, keyFile [string](/builtin#string), handler Handler) [error](/builtin#error)
...
####  func [MaxBytesReader](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1186) ¶
    
    
    func MaxBytesReader(w ResponseWriter, r [io](/io).[ReadCloser](/io#ReadCloser), n [int64](/builtin#int64)) [io](/io).[ReadCloser](/io#ReadCloser)
...
####  func [NotFound](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2358) ¶
...
####  func [ParseHTTPVersion](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=817) ¶
...
####  func [ParseTime](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=129) ¶ added in go1.1
    
    
    func ParseTime(text [string](/builtin#string)) (t [time](/time).[Time](/time#Time), err [error](/builtin#error))

ParseTime parses a time header (such as the Date: header), trying each of the three formats allowed by HTTP/1.1: TimeFormat, [time.RFC850](/time#RFC850), and [time.ANSIC](/time#ANSIC). 

####  func [ProxyFromEnvironment](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=499) ¶
    
    
    func ProxyFromEnvironment(req *Request) (*[url](/net/url).[URL](/net/url#URL), [error](/builtin#error))
...
####  func [ProxyURL](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=505) ¶
    
    
    func ProxyURL(fixedURL *[url](/net/url).[URL](/net/url#URL)) func(*Request) (*[url](/net/url).[URL](/net/url#URL), [error](/builtin#error))

ProxyURL returns a proxy function (for use in a Transport) that always returns the same URL. 

####  func [Redirect](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2403) ¶
    
    
    func Redirect(w ResponseWriter, r *Request, url [string](/builtin#string), code [int](/builtin#int))
...
####  func [Serve](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2969) ¶
    
    
    func Serve(l [net](/net).[Listener](/net#Listener), handler Handler) [error](/builtin#error)
...
####  func [ServeContent](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=245) ¶
    
    
    func ServeContent(w ResponseWriter, req *Request, name [string](/builtin#string), modtime [time](/time).[Time](/time#Time), content [io](/io).[ReadSeeker](/io#ReadSeeker))
...
####  func [ServeFile](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=814) ¶
    
    
    func ServeFile(w ResponseWriter, r *Request, name [string](/builtin#string))
...
####  func [ServeFileFS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=848) ¶ added in go1.22.0
    
    
    func ServeFileFS(w ResponseWriter, r *Request, fsys [fs](/io/fs).[FS](/io/fs#FS), name [string](/builtin#string))
...
####  func [ServeTLS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2986) ¶ added in go1.9
    
    
    func ServeTLS(l [net](/net).[Listener](/net#Listener), handler Handler, certFile, keyFile [string](/builtin#string)) [error](/builtin#error)
...
####  func [SetCookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=251) ¶
...
####  func [StatusText](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/status.go;l=81) ¶
...
####  type [Client](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=57) ¶
    ...
    type Client struct {
    	...
    	CheckRedirect func(req *Request, via []*Request) [error](/builtin#error)
...
####  func (*Client) [CloseIdleConnections](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=953) ¶ added in go1.12
...
####  func (*Client) [Do](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=586) ¶
    
    
    func (c *Client) Do(req *Request) (*Response, [error](/builtin#error))
...
####  func (*Client) [Get](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=479) ¶
    
    
    func (c *Client) Get(url [string](/builtin#string)) (resp *Response, err [error](/builtin#error))
...
An error is returned if the [Client.CheckRedirect] function fails or if there was an HTTP protocol error. A non-2xx response doesn't cause an error. Any returned error will be of type [*url.Error](/net/url#Error). The url.Error value's Timeout method will report true if the request timed out. 
...
####  func (*Client) [Head](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=938) ¶
    
    
    func (c *Client) Head(url [string](/builtin#string)) (resp *Response, err [error](/builtin#error))
...
To make a request with a specified [context.Context](/context#Context), use NewRequestWithContext and Client.Do. 

####  func (*Client) [Post](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=861) ¶
    
    
    func (c *Client) Post(url, contentType [string](/builtin#string), body [io](/io).[Reader](/io#Reader)) (resp *Response, err [error](/builtin#error))
...
####  func (*Client) [PostForm](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=904) ¶
    
    
    func (c *Client) PostForm(url [string](/builtin#string), data [url](/net/url).[Values](/net/url#Values)) (resp *Response, err [error](/builtin#error))
...
####  type [CloseNotifier](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=217) deprecated added in go1.1
...
####  type [ConnState](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3266) ¶ added in go1.3
...
A ConnState represents the state of a client connection to a server. It's used by the optional [Server.ConnState] hook. 
    ...
    const (
    	...
    	// StateClosed.
    	StateNew ConnState = [iota](/builtin#iota)
...
####  func (ConnState) [String](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3312) ¶ added in go1.3
    
    
    func (c ConnState) String() [string](/builtin#string)

####  type [Cookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=26) ¶
...
####  func [ParseCookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=91) ¶ added in go1.23.0
    
    
    func ParseCookie(line [string](/builtin#string)) ([]*Cookie, [error](/builtin#error))
...
####  func [ParseSetCookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=120) ¶ added in go1.23.0
    
    
    func ParseSetCookie(line [string](/builtin#string)) (*Cookie, [error](/builtin#error))

ParseSetCookie parses a Set-Cookie header value and returns a cookie. It returns an error on syntax error. 

####  func (*Cookie) [String](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=261) ¶
    
    
    func (c *Cookie) String() [string](/builtin#string)
...
####  func (*Cookie) [Valid](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=328) ¶ added in go1.18
    
    
    func (c *Cookie) Valid() [error](/builtin#error)

Valid reports whether the cookie is valid. 

####  type [CookieJar](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/jar.go;l=17) ¶
    ...
    type CookieJar interface {
    	...
    	SetCookies(u *[url](/net/url).[URL](/net/url#URL), cookies []*Cookie)
    
    	// Cookies returns the cookies to send in a request for the given URL.
    	// It is up to the implementation to honor the standard cookie use
    	// restrictions such as in [RFC 6265](https://rfc-editor.org/rfc/rfc6265.html).
    	Cookies(u *[url](/net/url).[URL](/net/url#URL)) []*Cookie
    }
...
####  type [CrossOriginProtection](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=36) ¶ added in go1.25.0
...
####  func [NewCrossOriginProtection](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=44) ¶ added in go1.25.0
...
####  func (*CrossOriginProtection) [AddInsecureBypassPattern](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=95) ¶ added in go1.25.0
    
    
    func (c *CrossOriginProtection) AddInsecureBypassPattern(pattern [string](/builtin#string))
...
####  func (*CrossOriginProtection) [AddTrustedOrigin](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=57) ¶ added in go1.25.0
    
    
    func (c *CrossOriginProtection) AddTrustedOrigin(origin [string](/builtin#string)) [error](/builtin#error)
...
####  func (*CrossOriginProtection) [Check](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=130) ¶ added in go1.25.0
    
    
    func (c *CrossOriginProtection) Check(req *Request) [error](/builtin#error)

Check applies cross-origin checks to a request. It returns an error if the request should be rejected. 

####  func (*CrossOriginProtection) [Handler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=202) ¶ added in go1.25.0
...
####  func (*CrossOriginProtection) [SetDenyHandler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/csrf.go;l=120) ¶ added in go1.25.0
...
####  type [Dir](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=44) ¶
...
While the [FileSystem.Open] method takes '/'-separated paths, a Dir's string value is a directory path on the native file system, not a URL, so it is separated by [filepath.Separator](/path/filepath#Separator), which isn't necessarily '/'. 
...
####  func (Dir) [Open](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=77) ¶
    
    
    func (d Dir) Open(name [string](/builtin#string)) (File, [error](/builtin#error))

Open implements FileSystem using [os.Open](/os#Open), opening files for reading rooted and relative to the directory d. 

####  type [File](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=113) ¶
...
####  type [FileSystem](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=105) ¶
    
    
    type FileSystem interface {
    	Open(name [string](/builtin#string)) (File, [error](/builtin#error))
    }
...
This interface predates the [fs.FS](/io/fs#FS) interface, which can be used instead: the FS adapter function converts an fs.FS to a FileSystem. 

####  func [FS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=954) ¶ added in go1.16
    
    
    func FS(fsys [fs](/io/fs).[FS](/io/fs#FS)) FileSystem

FS converts fsys to a FileSystem implementation, for use with FileServer and NewFileTransport. The files provided by fsys must implement [io.Seeker](/io#Seeker). 

####  type [Flusher](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=174) ¶
...
####  type [HTTP2Config](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=236) ¶ added in go1.24.0
...
####  type [Handler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=88) ¶
...
####  func [AllowQuerySemicolons](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3354) ¶ added in go1.17
...
####  func [FileServer](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=971) ¶
...
To use an [fs.FS](/io/fs#FS) implementation, use http.FileServerFS instead. 
...
####  func [FileServerFS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/fs.go;l=984) ¶ added in go1.22.0
    
    
    func FileServerFS(root [fs](/io/fs).[FS](/io/fs#FS)) Handler
...
####  func [MaxBytesHandler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=4096) ¶ added in go1.18
    
    
    func MaxBytesHandler(h Handler, n [int64](/builtin#int64)) Handler

MaxBytesHandler returns a Handler that runs h with its ResponseWriter and [Request.Body] wrapped by a MaxBytesReader. 

####  func [NotFoundHandler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2362) ¶
...
####  func [RedirectHandler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2488) ¶
    
    
    func RedirectHandler(url [string](/builtin#string), code [int](/builtin#int)) Handler
...
####  func [StripPrefix](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2370) ¶
    
    
    func StripPrefix(prefix [string](/builtin#string), h Handler) Handler
...
####  func [TimeoutHandler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3816) ¶
    
    
    func TimeoutHandler(h Handler, dt [time](/time).[Duration](/time#Duration), msg [string](/builtin#string)) Handler
...
####  type [HandlerFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2318) ¶
...
####  func (HandlerFunc) [ServeHTTP](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2321) ¶
...
####  type [Header](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=24) ¶
...
####  func (Header) [Add](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=30) ¶
    
    
    func (h Header) Add(key, value [string](/builtin#string))
...
####  func (Header) [Clone](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=94) ¶ added in go1.13
...
####  func (Header) [Del](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=80) ¶
    
    
    func (h Header) Del(key [string](/builtin#string))

Del deletes the values associated with key. The key is case insensitive; it is canonicalized by CanonicalHeaderKey. 

####  func (Header) [Get](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=49) ¶
    
    
    func (h Header) Get(key [string](/builtin#string)) [string](/builtin#string)
...
####  func (Header) [Set](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=39) ¶
    
    
    func (h Header) Set(key, value [string](/builtin#string))

Set sets the header entries associated with key to the single element value. It replaces any existing values associated with key. The key is case insensitive; it is canonicalized by [textproto.CanonicalMIMEHeaderKey](/net/textproto#CanonicalMIMEHeaderKey). To use non-canonical keys, assign to the map directly. 

####  func (Header) [Values](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=58) ¶ added in go1.14
    
    
    func (h Header) Values(key [string](/builtin#string)) [][string](/builtin#string)
...
####  func (Header) [Write](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=85) ¶
    
    
    func (h Header) Write(w [io](/io).[Writer](/io#Writer)) [error](/builtin#error)

Write writes a header in wire format. 

####  func (Header) [WriteSubset](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/header.go;l=186) ¶
    
    
    func (h Header) WriteSubset(w [io](/io).[Writer](/io#Writer), exclude map[[string](/builtin#string)][bool](/builtin#bool)) [error](/builtin#error)
...
####  type [Hijacker](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=186) ¶
...
####  type [MaxBytesError](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1194) ¶ added in go1.19
...
####  func (*MaxBytesError) [Error](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1198) ¶ added in go1.19
    
    
    func (e *MaxBytesError) Error() [string](/builtin#string)

####  type [ProtocolError](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=47) deprecated
...
####  func (*ProtocolError) [Error](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=51) ¶
    
    
    func (pe *ProtocolError) Error() [string](/builtin#string)

####  func (*ProtocolError) [Is](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=54) ¶ added in go1.21.0
    
    
    func (pe *ProtocolError) Is(err [error](/builtin#error)) [bool](/builtin#bool)

Is lets http.ErrNotSupported match errors.ErrUnsupported. 

####  type [Protocols](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=30) ¶ added in go1.24.0
...
####  func (Protocols) [HTTP1](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=41) ¶ added in go1.24.0
    
    
    func (p Protocols) HTTP1() [bool](/builtin#bool)

HTTP1 reports whether p includes HTTP/1. 

####  func (Protocols) [HTTP2](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=47) ¶ added in go1.24.0
    
    
    func (p Protocols) HTTP2() [bool](/builtin#bool)

HTTP2 reports whether p includes HTTP/2. 

####  func (*Protocols) [SetHTTP1](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=44) ¶ added in go1.24.0
    
    
    func (p *Protocols) SetHTTP1(ok [bool](/builtin#bool))

SetHTTP1 adds or removes HTTP/1 from p. 

####  func (*Protocols) [SetHTTP2](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=50) ¶ added in go1.24.0
    
    
    func (p *Protocols) SetHTTP2(ok [bool](/builtin#bool))

SetHTTP2 adds or removes HTTP/2 from p. 

####  func (*Protocols) [SetUnencryptedHTTP2](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=56) ¶ added in go1.24.0
    
    
    func (p *Protocols) SetUnencryptedHTTP2(ok [bool](/builtin#bool))

SetUnencryptedHTTP2 adds or removes unencrypted HTTP/2 from p. 

####  func (Protocols) [String](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=66) ¶ added in go1.24.0
    
    
    func (p Protocols) String() [string](/builtin#string)

####  func (Protocols) [UnencryptedHTTP2](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=53) ¶ added in go1.24.0
    
    
    func (p Protocols) UnencryptedHTTP2() [bool](/builtin#bool)

UnencryptedHTTP2 reports whether p includes unencrypted HTTP/2. 

####  type [PushOptions](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=192) ¶ added in go1.8
...
####  type [Pusher](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/http.go;l=206) ¶ added in go1.8
    ...
    type Pusher interface {
    	...
    	Push(target [string](/builtin#string), opts *PushOptions) [error](/builtin#error)
    }
...
####  type [Request](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=113) ¶
...
####  func [NewRequest](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=862) ¶
    
    
    func NewRequest(method, url [string](/builtin#string), body [io](/io).[Reader](/io#Reader)) (*Request, [error](/builtin#error))

NewRequest wraps NewRequestWithContext using [context.Background](/context#Background). 

####  func [NewRequestWithContext](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=889) ¶ added in go1.13
    
    
    func NewRequestWithContext(ctx [context](/context).[Context](/context#Context), method, url [string](/builtin#string), body [io](/io).[Reader](/io#Reader)) (*Request, [error](/builtin#error))

NewRequestWithContext returns a new Request given a method, URL, and optional body. 

If the provided body is also an [io.Closer](/io#Closer), the returned [Request.Body] is set to body and will be closed (possibly asynchronously) by the Client methods Do, Post, and PostForm, and Transport.RoundTrip. 
...
If body is of type [*bytes.Buffer](/bytes#Buffer), [*bytes.Reader](/bytes#Reader), or [*strings.Reader](/strings#Reader), the returned request's ContentLength is set to its exact value (instead of -1), GetBody is populated (so 307 and 308 redirects can replay the body), and Body is set to NoBody if the ContentLength is 0. 

####  func [ReadRequest](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1058) ¶
    
    
    func ReadRequest(b *[bufio](/bufio).[Reader](/bufio#Reader)) (*Request, [error](/builtin#error))
...
####  func (*Request) [AddCookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=464) ¶
...
####  func (*Request) [BasicAuth](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=973) ¶ added in go1.4
    
    
    func (r *Request) BasicAuth() (username, password [string](/builtin#string), ok [bool](/builtin#bool))
...
####  func (*Request) [Clone](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=386) ¶ added in go1.13
    
    
    func (r *Request) Clone(ctx [context](/context).[Context](/context#Context)) *Request
...
####  func (*Request) [Context](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=352) ¶ added in go1.7
...
####  func (*Request) [Cookie](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=448) ¶
    
    
    func (r *Request) Cookie(name [string](/builtin#string)) (*Cookie, [error](/builtin#error))
...
####  func (*Request) [Cookies](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=428) ¶
...
####  func (*Request) [CookiesNamed](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=434) ¶ added in go1.23.0
    
    
    func (r *Request) CookiesNamed(name [string](/builtin#string)) []*Cookie

CookiesNamed parses and returns the named HTTP cookies sent with the request or an empty slice if none matched. 

####  func (*Request) [FormFile](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1446) ¶
    
    
    func (r *Request) FormFile(key [string](/builtin#string)) ([multipart](/mime/multipart).[File](/mime/multipart#File), *[multipart](/mime/multipart).[FileHeader](/mime/multipart#FileHeader), [error](/builtin#error))
...
####  func (*Request) [FormValue](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1419) ¶
    
    
    func (r *Request) FormValue(key [string](/builtin#string)) [string](/builtin#string)
...
####  func (*Request) [MultipartReader](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=497) ¶
    
    
    func (r *Request) MultipartReader() (*[multipart](/mime/multipart).[Reader](/mime/multipart#Reader), [error](/builtin#error))
...
####  func (*Request) [ParseForm](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1327) ¶
    
    
    func (r *Request) ParseForm() [error](/builtin#error)
...
####  func (*Request) [ParseMultipartForm](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1370) ¶
    
    
    func (r *Request) ParseMultipartForm(maxMemory [int64](/builtin#int64)) [error](/builtin#error)
...
####  func (*Request) [PathValue](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1469) ¶ added in go1.22.0
    
    
    func (r *Request) PathValue(name [string](/builtin#string)) [string](/builtin#string)
...
####  func (*Request) [PostFormValue](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1434) ¶ added in go1.1
    
    
    func (r *Request) PostFormValue(key [string](/builtin#string)) [string](/builtin#string)
...
####  func (*Request) [ProtoAtLeast](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=417) ¶
    
    
    func (r *Request) ProtoAtLeast(major, minor [int](/builtin#int)) [bool](/builtin#bool)

ProtoAtLeast reports whether the HTTP protocol used in the request is at least major.minor. 

####  func (*Request) [Referer](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=481) ¶
    
    
    func (r *Request) Referer() [string](/builtin#string)
...
####  func (*Request) [SetBasicAuth](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1022) ¶
    
    
    func (r *Request) SetBasicAuth(username, password [string](/builtin#string))
...
####  func (*Request) [SetPathValue](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=1478) ¶ added in go1.22.0
    
    
    func (r *Request) SetPathValue(name, value [string](/builtin#string))

SetPathValue sets name to value, so that subsequent calls to r.PathValue(name) return value. 

####  func (*Request) [UserAgent](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=423) ¶
    
    
    func (r *Request) UserAgent() [string](/builtin#string)

UserAgent returns the client's User-Agent, if sent in the request. 

####  func (*Request) [WithContext](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=368) ¶ added in go1.7
    
    
    func (r *Request) WithContext(ctx [context](/context).[Context](/context#Context)) *Request
...
####  func (*Request) [Write](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=561) ¶
    
    
    func (r *Request) Write(w [io](/io).[Writer](/io#Writer)) [error](/builtin#error)
...
####  func (*Request) [WriteProxy](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/request.go;l=571) ¶
    
    
    func (r *Request) WriteProxy(w [io](/io).[Writer](/io#Writer)) [error](/builtin#error)
...
####  type [Response](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=35) ¶
...
####  func [Get](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=452) ¶
    
    
    func Get(url [string](/builtin#string)) (resp *Response, err [error](/builtin#error))
...
####  func [Head](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=922) ¶
    
    
    func Head(url [string](/builtin#string)) (resp *Response, err [error](/builtin#error))
...
To make a request with a specified [context.Context](/context#Context), use NewRequestWithContext and DefaultClient.Do. 

####  func [Post](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=843) ¶
    
    
    func Post(url, contentType [string](/builtin#string), body [io](/io).[Reader](/io#Reader)) (resp *Response, err [error](/builtin#error))
...
####  func [PostForm](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=886) ¶
    
    
    func PostForm(url [string](/builtin#string), data [url](/net/url).[Values](/net/url#Values)) (resp *Response, err [error](/builtin#error))
...
####  func [ReadResponse](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=154) ¶
    
    
    func ReadResponse(r *[bufio](/bufio).[Reader](/bufio#Reader), req *Request) (*Response, [error](/builtin#error))
...
####  func (*Response) [Cookies](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=125) ¶
...
####  func (*Response) [Location](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=137) ¶
    
    
    func (r *Response) Location() (*[url](/net/url).[URL](/net/url#URL), [error](/builtin#error))
...
####  func (*Response) [ProtoAtLeast](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=224) ¶
    
    
    func (r *Response) ProtoAtLeast(major, minor [int](/builtin#int)) [bool](/builtin#bool)

ProtoAtLeast reports whether the HTTP protocol used in the response is at least major.minor. 

####  func (*Response) [Write](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/response.go;l=245) ¶
    
    
    func (r *Response) Write(w [io](/io).[Writer](/io#Writer)) [error](/builtin#error)
...
####  type [ResponseController](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=17) ¶ added in go1.20
...
####  func [NewResponseController](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=38) ¶ added in go1.20
...
####  func (*ResponseController) [EnableFullDuplex](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=129) ¶ added in go1.21.0
    
    
    func (c *ResponseController) EnableFullDuplex() [error](/builtin#error)
...
####  func (*ResponseController) [Flush](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=47) ¶ added in go1.20
    
    
    func (c *ResponseController) Flush() [error](/builtin#error)

Flush flushes buffered data to the client. 

####  func (*ResponseController) [Hijack](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=66) ¶ added in go1.20
    
    
    func (c *ResponseController) Hijack() ([net](/net).[Conn](/net#Conn), *[bufio](/bufio).[ReadWriter](/bufio#ReadWriter), [error](/builtin#error))

Hijack lets the caller take over the connection. See the Hijacker interface for details. 

####  func (*ResponseController) [SetReadDeadline](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=85) ¶ added in go1.20
    
    
    func (c *ResponseController) SetReadDeadline(deadline [time](/time).[Time](/time#Time)) [error](/builtin#error)
...
####  func (*ResponseController) [SetWriteDeadline](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/responsecontroller.go;l=105) ¶ added in go1.20
    
    
    func (c *ResponseController) SetWriteDeadline(deadline [time](/time).[Time](/time#Time)) [error](/builtin#error)
...
####  type [ResponseWriter](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=96) ¶
...
####  type [RoundTripper](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/client.go;l=116) ¶
    ...
    type RoundTripper interface {
    	...
    	RoundTrip(*Request) (*Response, [error](/builtin#error))
    }
...
####  func [NewFileTransport](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/filetransport.go;l=31) ¶
...
####  func [NewFileTransportFS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/filetransport.go;l=49) ¶ added in go1.22.0
    
    
    func NewFileTransportFS(fsys [fs](/io/fs).[FS](/io/fs#FS)) RoundTripper

NewFileTransportFS returns a new RoundTripper, serving the provided file system fsys. The returned RoundTripper ignores the URL host in its incoming requests, as well as most other properties of the request. The files provided by fsys must implement [io.Seeker](/io#Seeker). 
...
####  type [SameSite](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/cookie.go;l=54) ¶ added in go1.11
...
See <https://tools.ietf.org/html/draft-ietf-httpbis-cookie-same-site-00> for details. 
    ...
    const (
    	SameSiteDefaultMode SameSite = [iota](/builtin#iota) + 1
    	SameSiteLaxMode
    	SameSiteStrictMode
    	SameSiteNoneMode
    )

####  type [ServeMux](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2611) ¶
...
####  func [NewServeMux](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2619) ¶
...
####  func (*ServeMux) [Handle](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2870) ¶
    
    
    func (mux *ServeMux) Handle(pattern [string](/builtin#string), handler Handler)
...
####  func (*ServeMux) [HandleFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2881) ¶
    
    
    func (mux *ServeMux) HandleFunc(pattern [string](/builtin#string), handler func(ResponseWriter, *Request))
...
####  func (*ServeMux) [Handler](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2683) ¶ added in go1.1
    
    
    func (mux *ServeMux) Handler(r *Request) (h Handler, pattern [string](/builtin#string))
...
####  func (*ServeMux) [ServeHTTP](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2847) ¶
...
####  type [Server](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=2993) ¶
    ...
    type Server struct {
    	...
    	// automatically.
    	TLSNextProto map[[string](/builtin#string)]func(*Server, *[tls](/crypto/tls).[Conn](/crypto/tls#Conn), Handler)
    
    	// ConnState specifies an optional callback function that is
    	// called when a client connection changes state. See the
    	// ConnState type and associated constants for details.
    	ConnState func([net](/net).[Conn](/net#Conn), ConnState)
...
####  func (*Server) [Close](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3129) ¶ added in go1.8
    
    
    func (s *Server) Close() [error](/builtin#error)
...
####  func (*Server) [ListenAndServe](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3377) ¶
    
    
    func (s *Server) ListenAndServe() [error](/builtin#error)
...
####  func (*Server) [ListenAndServeTLS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3732) ¶
    
    
    func (s *Server) ListenAndServeTLS(certFile, keyFile [string](/builtin#string)) [error](/builtin#error)
...
####  func (*Server) [RegisterOnShutdown](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3222) ¶ added in go1.9
...
####  func (*Server) [Serve](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3433) ¶
    
    
    func (s *Server) Serve(l [net](/net).[Listener](/net#Listener)) [error](/builtin#error)
...
####  func (*Server) [ServeTLS](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3511) ¶ added in go1.9
    
    
    func (s *Server) ServeTLS(l [net](/net).[Listener](/net#Listener), certFile, keyFile [string](/builtin#string)) [error](/builtin#error)
...
####  func (*Server) [SetKeepAlivesEnabled](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3662) ¶ added in go1.3
    
    
    func (s *Server) SetKeepAlivesEnabled(v [bool](/builtin#bool))
...
####  func (*Server) [Shutdown](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/server.go;l=3179) ¶ added in go1.8
    
    
    func (s *Server) Shutdown(ctx [context](/context).[Context](/context#Context)) [error](/builtin#error)
...
####  type [Transport](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=96) ¶
    ...
    type Transport struct {
    	...
    	Proxy func(*Request) (*[url](/net/url).[URL](/net/url#URL), [error](/builtin#error))
    
    	// OnProxyConnectResponse is called when the Transport gets an HTTP response from
    	// a proxy for a CONNECT request. It's called before the check for a 200 OK response.
    	// If it returns an error, the request fails with that error.
    	OnProxyConnectResponse func(ctx [context](/context).[Context](/context#Context), proxyURL *[url](/net/url).[URL](/net/url#URL), connectReq *Request, connectRes *Response) [error](/builtin#error)
    	...
    	// If TLSNextProto is not nil, HTTP/2 support is not enabled
    	// automatically.
    	TLSNextProto map[[string](/builtin#string)]func(authority [string](/builtin#string), c *[tls](/crypto/tls).[Conn](/crypto/tls#Conn)) RoundTripper
    	...
    	// ignored.
    	GetProxyConnectHeader func(ctx [context](/context).[Context](/context#Context), proxyURL *[url](/net/url).[URL](/net/url#URL), target [string](/builtin#string)) (Header, [error](/builtin#error))
...
####  func (*Transport) [CancelRequest](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=941) deprecated added in go1.1
...
####  func (*Transport) [Clone](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=329) ¶ added in go1.13
...
####  func (*Transport) [CloseIdleConnections](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=887) ¶
...
####  func (*Transport) [RegisterProtocol](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/transport.go;l=868) ¶
    
    
    func (t *Transport) RegisterProtocol(scheme [string](/builtin#string), rt RoundTripper)
...
####  func (*Transport) [RoundTrip](https://cs.opensource.google/go/go/+/go1.25.6:src/net/http/roundtrip.go;l=29) ¶
    
    
    func (t *Transport) RoundTrip(req *Request) (*Response, [error](/builtin#error))
