...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=167)
    
    
    var Canceled = [errors](/errors).[New](/errors#New)("context canceled")
...
[View Source](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=171)
    
    
    var DeadlineExceeded [error](/builtin#error) = deadlineExceededError{}

DeadlineExceeded is the error returned by [Context.Err] when the context is canceled due to its deadline passing. 

### Functions ¶

####  func [AfterFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=325) ¶ added in go1.21.0
    
    
    func AfterFunc(ctx Context, f func()) (stop func() [bool](/builtin#bool))
...
####  func [Cause](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=288) ¶ added in go1.20
    
    
    func Cause(c Context) [error](/builtin#error)
...
####  func [WithCancel](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=240) ¶
...
####  func [WithCancelCause](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=268) ¶ added in go1.20
...
####  func [WithDeadline](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=625) ¶
    
    
    func WithDeadline(parent Context, d [time](/time).[Time](/time#Time)) (Context, CancelFunc)
...
####  func [WithDeadlineCause](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=632) ¶ added in go1.21.0
    
    
    func WithDeadlineCause(parent Context, d [time](/time).[Time](/time#Time), cause [error](/builtin#error)) (Context, CancelFunc)
...
####  func [WithTimeout](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=703) ¶
    
    
    func WithTimeout(parent Context, timeout [time](/time).[Duration](/time#Duration)) (Context, CancelFunc)
...
####  func [WithTimeoutCause](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=710) ¶ added in go1.21.0
    
    
    func WithTimeoutCause(parent Context, timeout [time](/time).[Duration](/time#Duration), cause [error](/builtin#error)) (Context, CancelFunc)
...
####  type [CancelCauseFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=255) ¶ added in go1.20
    
    
    type CancelCauseFunc func(cause [error](/builtin#error))
...
####  type [CancelFunc](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=231) ¶
...
####  type [Context](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=71) ¶
    ...
    type Context interface {
    	...
    	Deadline() (deadline [time](/time).[Time](/time#Time), ok [bool](/builtin#bool))
    	...
    	// 		return u, ok
    	// 	}
    	Value(key [any](/builtin#any)) [any](/builtin#any)
    }
...
####  func [Background](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=215) ¶
...
####  func [TODO](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=223) ¶
...
####  func [WithValue](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=727) ¶
    
    
    func WithValue(parent Context, key, val [any](/builtin#any)) Context
...
####  func [WithoutCancel](https://cs.opensource.google/go/go/+/go1.25.6:src/context/context.go;l=585) ¶ added in go1.21.0
