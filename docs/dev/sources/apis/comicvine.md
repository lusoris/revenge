...
> Fetched: 2026-01-30T23:50:45.662609+00:00
> Content-Hash: ab984404dcd7b060
> Type: html
...
The data format of the response takes either xml, json, or jsonp.

field_list

List of field names to include in the response. Use this if you want to reduce the size of the response payload. This filter can
...
The number of results to display per page.  This value defaults to 100 and can not exceed this number.
...
The result set can be sorted by the marked fields in the Fields section below. Format: &sort=field:direction where direction is
either asc or desc.
...
Number of issues this concept appears in.
...
A list of characters that died in this episode.
...
A list of objects in which this episode is the first appearance of the object.
...
List of objects that appeared in this episode.

person_credits

List of people that worked on this episode.
...
The number assigned to the episode within the volume set.
...
List of objects that appeared in this issue.
...
List of teams that disbanded in this issue.
...
List of things found in this movie.
...
Date the object was added to Comic Vine.

date_last_updated

Date the object was last updated on Comic Vine.
...
Issue where the object made its first appearance.
...
List of comic volumes this object appears in.
...
Number of issues this person appears in.
...
List of locations that appeared in this series.
...
List of aliases the series_list is known by. A \n (newline) seperates each alias.

api_detail_url

URL pointing to the series_list detail resource.

count_of_episodes

Number of episodes included in this series_list.

date_added

Date the series_list was added to Comic Vine.

date_last_updated

Date the series_list was last updated on Comic Vine.

deck

Brief summary of the series_list.

description

Description of the series_list.

first_episode

The first episode in this series_list.

id

Unique ID of the series_list.

image

Main image of the series_list.

last_episode

The last episode in this series_list.

name

Name of the series_list.

publisher

The primary publisher a series_list is attached to.

site_detail_url

URL pointing to the series_list on Giant Bomb.

start_year

The first year this series_list appeared in comics.
...
The number of results to display per page.  This value defaults to 10 and can not exceed this number.
...
List of resources to filter results.  This filter can accept multiple arguments, each delimited with a ",".  Available options
are:
...
Number of issues this story_arc appears in.
