...
Users work with the APIs through declaring objects as _yaml_ or _json_ config, and using common tooling to manage the objects.
...
If you like to contribute to either this book or the code, please be so kind to read our [Contribution](https://github.com/kubernetes-sigs/kubebuilder/blob/master/CONTRIBUTING.md) guidelines first.
