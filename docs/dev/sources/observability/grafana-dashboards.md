...
> Fetched: 2026-01-30T23:55:17.352712+00:00
> Content-Hash: 6dc71b39dc6ef4b1
> Type: html
...
When you’ve finished viewing the JSON, click
...
In the following JSON, id is shown as null which is the default value assigned to it until a dashboard is saved. Once a dashboard is saved, an integer value is assigned to the
...
The x position, in same unit as
...
The y position, in same unit as
...
whether timepicker is hidden or not
...
format to use while fetching all values from data source, eg:
