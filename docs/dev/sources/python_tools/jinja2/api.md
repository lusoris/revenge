...
> Fetched: 2026-01-31T16:07:59.677199+00:00
...
_class _jinja2.Environment([_options_])¶
...
Parameters:
  ...
  * **newline_sequence** (_te.Literal_ _[__'\n'__,__'\r\n'__,__'\r'__]_)
  ...
  * **finalize** ([_Callable_](https://docs.python.org/3/library/typing.html#typing.Callable "\(in Python v3.13\)") _[__[__...__]__,_[_Any_](https://docs.python.org/3/library/typing.html#typing.Any "\(in Python v3.13\)") _]__|__None_)
...
Parameters:
  ...
  * **log_function** ([_Callable_](https://docs.python.org/3/library/typing.html#typing.Callable "\(in Python v3.13\)") _[__[_[_str_](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") _]__,__None_ _]__|__None_)
...
_async _render_async([_context_])¶
...
_async _generate_async([_context_])¶
...
_property _module _: TemplateModule_¶
...
_class _jinja2.ChainableUndefined¶
...
Parameters:
  ...
  * **_Context__obj** ([_Callable_](https://docs.python.org/3/library/typing.html#typing.Callable "\(in Python v3.13\)") _[__[__...__]__,_[_Any_](https://docs.python.org/3/library/typing.html#typing.Any "\(in Python v3.13\)") _]_)
...
_class _jinja2.FileSystemLoader(_searchpath_ , _encoding ='utf-8'_, _followlinks =False_)¶
...
_class _jinja2.PackageLoader(_package_name_ , _package_path ='templates'_, _encoding ='utf-8'_)¶
...
_class _jinja2.DictLoader(_mapping_)¶
...
_class _jinja2.FunctionLoader(_load_func_)¶
...
_class _jinja2.PrefixLoader(_mapping_ , _delimiter ='/'_)¶
...
_class _jinja2.ChoiceLoader(_loaders_)¶
...
_class _jinja2.ModuleLoader(_path_)¶
...
_class _jinja2.bccache.Bucket(_environment_ , _key_ , _checksum_)¶
...
_class _jinja2.FileSystemBytecodeCache(_directory =None_, _pattern ='__jinja2_%s.cache'_)¶
...
_class _jinja2.MemcachedBytecodeCache(_client_ , _prefix ='jinja2/bytecode/'_, _timeout =None_, _ignore_memcache_errors =True_)¶
...
_class _MinimalClientInterface¶
...
_exception _jinja2.TemplateError(_message =None_)¶
...
_exception _jinja2.UndefinedError(_message =None_)¶
...
_exception _jinja2.TemplateNotFound(_name_ , _message =None_)¶
...
_exception _jinja2.TemplatesNotFound(_names =()_, _message =None_)¶
...
_exception _jinja2.TemplateSyntaxError(_message_ , _lineno_ , _name =None_, _filename =None_)¶
...
_exception _jinja2.TemplateRuntimeError(_message =None_)¶
...
_exception _jinja2.TemplateAssertionError(_message_ , _lineno_ , _name =None_, _filename =None_)¶
...
_class _jinja2.nodes.EvalContext(_environment_ , _template_name =None_)¶
