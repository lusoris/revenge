...
> Fetched: 2026-01-31T16:07:57.488655+00:00
> Content-Hash: d8a02fd7b435d901
> Type: html
...
### Navigation
  ...
  * [previous](../nativetypes/ "Native Python Types") |
...
Line Statements and Comments are also possible, though they don’t have default prefix characters. To use them, set `line_statement_prefix` and `line_comment_prefix` when creating the [`Environment`](../api/#jinja2.Environment "jinja2.Environment").
...
The `{% extends %}` tag is the key here. It tells the template engine that this template “extends” another template. When the template system evaluates this template, it first locates the parent. The extends tag should be the first tag in the template. Everything before it is printed out normally and may cause confusion. For details about this behavior and how to take advantage of it, see [Null-Default Fallback](../tricks/#null-default-fallback). Also a block will always be filled in regardless of whether the surrounding condition is evaluated to be true or false.

The filename of the template depends on the template loader. For example, the [`FileSystemLoader`](../api/#jinja2.FileSystemLoader "jinja2.FileSystemLoader") allows you to access other templates by giving the filename. You can access templates in subdirectories with a slash:
...
The `else` part is optional. If not provided, the else block implicitly evaluates into an [`Undefined`](../api/#jinja2.Undefined "jinja2.Undefined") object (regardless of what `undefined` in the environment is set to):
...
jinja-filters.attr(_obj : Any_, _name : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [jinja2.runtime.Undefined](../api/#jinja2.Undefined "jinja2.runtime.Undefined") | Any¶
...
jinja-filters.batch(_value : 't.Iterable[V]'_, _linecount : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_, _fill_with : 't.Optional[V]' = None_) → 't.Iterator[t.List[V]]'¶
...
jinja-filters.capitalize(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Capitalize a value. The first character will be uppercase, all others lowercase.

jinja-filters.center(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _width : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 80_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Centers the value in a field of a given width.

jinja-filters.default(_value : V_, _default_value : V = ''_, _boolean : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_) → V¶
...
Changed in version 2.11: It’s now possible to configure the [`Environment`](../api/#jinja2.Environment "jinja2.Environment") with [`ChainableUndefined`](../api/#jinja2.ChainableUndefined "jinja2.ChainableUndefined") to make the `default` filter work on nested elements and attributes that may contain undefined values in the chain without getting an [`UndefinedError`](../api/#jinja2.UndefinedError "jinja2.UndefinedError").
...
jinja-filters.dictsort(_value : Mapping[K, V]_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _by : 'te.Literal["key", "value"]' = 'key'_, _reverse : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_) → [List](../extensions/#jinja2.nodes.List "jinja2.nodes.List")[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[K, V]]¶
...
jinja-filters.escape(_s : 't.Any'_, _/_) → 'Markup'¶
...
jinja-filters.float(_value : Any_, _default : [float](https://docs.python.org/3/library/functions.html#float "\(in Python v3.13\)") = 0.0_) → [float](https://docs.python.org/3/library/functions.html#float "\(in Python v3.13\)")¶
...
jinja-filters.format(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _* args: Any_, _** kwargs: Any_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
In most cases it should be more convenient and efficient to use the `%` operator or [`str.format()`](https://docs.python.org/3/library/stdtypes.html#str.format "\(in Python v3.13\)").
...
jinja-filters.groupby(_value : 't.Iterable[V]'_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_, _default : Any | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_) → 't.List[_GroupTuple]'¶
    

Group a sequence of objects by an attribute using Python’s [`itertools.groupby()`](https://docs.python.org/3/library/itertools.html#itertools.groupby "\(in Python v3.13\)"). The attribute can use dot notation for nested access, like `"address.city"`. Unlike Python’s `groupby`, the values are sorted first so only one group is returned for each unique value.
...
jinja-filters.indent(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _width : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") = 4_, _first : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _blank : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.int(_value : Any_, _default : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 0_, _base : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 10_) → [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")¶
    

Convert the value into an integer. If the conversion doesn’t work it will return `0`. You can override this default using the first parameter. You can also override the default base (10) in the second parameter, which handles input with prefixes such as 0b, 0o and 0x for bases 2, 8 and 16 respectively. The base is ignored for decimal numbers and non-string values.

jinja-filters.items(_value : Mapping[K, V] | [jinja2.runtime.Undefined](../api/#jinja2.Undefined "jinja2.runtime.Undefined")_) → Iterator[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[K, V]]¶
...
jinja-filters.join(_value : Iterable[Any]_, _d : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") = ''_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.lower(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.max(_value : 't.Iterable[V]'_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_) → 't.Union[V, Undefined]'¶
...
jinja-filters.min(_value : 't.Iterable[V]'_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_) → 't.Union[V, Undefined]'¶
...
jinja-filters.pprint(_value : Any_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.replace(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _old : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _new : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _count : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.reverse(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | Iterable[V]_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | Iterable[V]¶
    

Reverse the object or return an iterator that iterates over it the other way round.

jinja-filters.round(_value : [float](https://docs.python.org/3/library/functions.html#float "\(in Python v3.13\)")_, _precision : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 0_, _method : 'te.Literal["common", "ceil", "floor"]' = 'common'_) → [float](https://docs.python.org/3/library/functions.html#float "\(in Python v3.13\)")¶
...
jinja-filters.safe(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → markupsafe.Markup¶
...
jinja-filters.slice(_value : 't.Collection[V]'_, _slices : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_, _fill_with : 't.Optional[V]' = None_) → 't.Iterator[t.List[V]]'¶
...
jinja-filters.sort(_value : 't.Iterable[V]'_, _reverse : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_) → 't.List[V]'¶
    

Sort an iterable using Python’s [`sorted()`](https://docs.python.org/3/library/functions.html#sorted "\(in Python v3.13\)").
...
jinja-filters.string(_s : 't.Any'_, _/_) → 'str'¶
...
jinja-filters.striptags(_value : 't.Union[str, HasHTML]'_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Strip SGML/XML tags and replace adjacent whitespace by one space.

jinja-filters.sum(_iterable : 't.Iterable[V]'_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_, _start : V = 0_) → V¶
...
jinja-filters.title(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Return a titlecased version of the value. I.e. words will start with uppercase letters, all remaining characters are lowercase.

jinja-filters.tojson(_value : Any_, _indent : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_) → markupsafe.Markup¶
...
jinja-filters.trim(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _chars : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Strip leading and trailing characters, by default whitespace.

jinja-filters.truncate(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _length : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 255_, _killwords : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _end : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") = '...'_, _leeway : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.unique(_value : 't.Iterable[V]'_, _case_sensitive : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _attribute : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | NoneType = None_) → 't.Iterator[V]'¶
...
jinja-filters.upper(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Convert a value to uppercase.

jinja-filters.urlencode(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | Mapping[[str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)"), Any] | Iterable[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[[str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)"), Any]]_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
    

Quote data for use in a URL path or query using UTF-8.

Basic wrapper around [`urllib.parse.quote()`](https://docs.python.org/3/library/urllib.parse.html#urllib.parse.quote "\(in Python v3.13\)") when given a string, or [`urllib.parse.urlencode()`](https://docs.python.org/3/library/urllib.parse.html#urllib.parse.urlencode "\(in Python v3.13\)") for a dict or iterable.
...
jinja-filters.urlize(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _trim_url_limit : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_, _nofollow : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = False_, _target : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_, _rel : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_, _extra_schemes : Iterable[[str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")] | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.wordcount(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")¶
    

Count the words in that string.

jinja-filters.wordwrap(_s : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_, _width : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)") = 79_, _break_long_words : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = True_, _wrapstring : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)") | [None](https://docs.python.org/3/library/constants.html#None "\(in Python v3.13\)") = None_, _break_on_hyphens : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = True_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-filters.xmlattr(_d : Mapping[[str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)"), Any]_, _autospace : [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)") = True_) → [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")¶
...
jinja-tests.boolean(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.defined(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.divisibleby(_value : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_, _num : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.escaped(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Check if the value is escaped.

jinja-tests.even(_value : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the variable is even.

jinja-tests.false(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.filter(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.float(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.in(_value : Any_, _seq : Container[Any]_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.integer(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.iterable(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.lower(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.mapping(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.none(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the variable is none.

jinja-tests.number(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the variable is a number.

jinja-tests.odd(_value : [int](https://docs.python.org/3/library/functions.html#int "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the variable is odd.

jinja-tests.sameas(_value : Any_, _other : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.sequence(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the variable is a sequence. Sequences are variables that are iterable.

jinja-tests.string(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Return true if the object is a string.

jinja-tests.test(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.true(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
jinja-tests.undefined(_value : Any_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
    

Like `defined()` but the other way round.

jinja-tests.upper(_value : [str](https://docs.python.org/3/library/stdtypes.html#str "\(in Python v3.13\)")_) → [bool](https://docs.python.org/3/library/functions.html#bool "\(in Python v3.13\)")¶
...
_class _jinja-globals.cycler(_\*items_)¶
...
_class _jinja-globals.joiner(_sep =', '_)¶
...
_class _jinja-globals.namespace(_..._)¶
...
The following sections cover the built-in Jinja extensions that may be enabled by an application. An application could also provide further extensions not covered by this documentation; in which case there should be a separate document explaining said [extensions](../extensions/#jinja-extensions).

### i18n¶

If the [i18n Extension](../extensions/#i18n-extension) is enabled, it’s possible to mark text in the template as translatable. To mark a section as translatable, use a `trans` block:
...
If [New Style Gettext](../extensions/#newstyle-gettext) calls are activated, using placeholders is easier. Formatting is part of the `gettext` call instead of using the `format` filter.
...
If the application enables the [Loop Controls](../extensions/#loopcontrols-extension), it’s possible to use `break` and `continue` in loops. When `break` is reached, the loop is terminated; if `continue` is reached, the processing is stopped and continues with the next iteration.
...
If the [Debug Extension](../extensions/#debug-extension) is enabled, a `{% debug %}` tag will be available to dump the current context as well as the available filters and tests. This is useful to see what’s available to use in the template without setting up a debugger.
...
### Navigation
  ...
  * [Overview](../)
    * Previous: [Native Python Types](../nativetypes/ "previous chapter")
    * Next: [Extensions](../extensions/ "next chapter")
