...
> Fetched: 2026-01-31T11:01:45.786237+00:00
> Content-Hash: bc7d2d1d3beadb4d
> Type: html
...
* * *
    ...
    1.  Introduction
       ...
       to be transmitted as a JSON [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")] object that is used as the
    ...
    2.  Terminology
       ...
       Glossary, Version 2" [[RFC4949](/doc/html/rfc4949 ""Internet Security Glossary, Version 2"")].
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       Collision-Resistant Name
          ...
          (UUIDs) [[RFC4122](/doc/html/rfc4122 ""A Universally Unique IDentifier \(UUID\) URN Namespace"")].  When using an administratively delegated
       ...
       StringOrURI
          ...
          character MUST be a URI [[RFC3986](/doc/html/rfc3986 ""Uniform Resource Identifier \(URI\): Generic Syntax"")].  StringOrURI values are
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       NumericDate
          ...
          than that non-integer values can be represented.  See [RFC 3339](/doc/html/rfc3339)
          [[RFC3339](/doc/html/rfc3339 ""Date and Time on the Internet: Timestamps"")] for details regarding date/times in general and UTC in
          particular.
    ...
    3.  JSON Web Token (JWT) Overview
       ...
       As per [Section 4 of RFC 7159](/doc/html/rfc7159#section-4) [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")], the JSON object consists of
       ...
       structural characters, in accordance with [Section 2 of RFC 7159](/doc/html/rfc7159#section-2)
       [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")].
...
* * *
    ...
    7.2.  Validating a JWT
       ...
       4.   Verify that the resulting octet sequence is a UTF-8-encoded
            ...
            [RFC 7159](/doc/html/rfc7159) [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")]; let the JOSE Header be this JSON object.
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       10.  Verify that the resulting octet sequence is a UTF-8-encoded
            representation of a completely valid JSON object conforming to
            [RFC 7159](/doc/html/rfc7159) [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")]; let the JWT Claims Set be this JSON object.
    ...
    7.3.  String Comparison Rules
       ...
       [Section 8.3 of RFC 7159](/doc/html/rfc7159#section-8.3) [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")].  Since the only string comparison
...
* * *
    ...
    10.1.  JSON Web Token Claims Registry
       ...
       Values are registered on a Specification Required [[RFC5226](/doc/html/rfc5226)] basis
...
* * *
    ...
    10.1.2.  Initial Registry Contents
       ...
       o  Specification Document(s): [Section 4.1.1 of RFC 7519](/doc/html/rfc7519#section-4.1.1)
    
       o  Claim Name: "sub"
       o  Claim Description: Subject
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.2 of RFC 7519](/doc/html/rfc7519#section-4.1.2)
    
       o  Claim Name: "aud"
       o  Claim Description: Audience
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.3 of RFC 7519](/doc/html/rfc7519#section-4.1.3)
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.4 of RFC 7519](/doc/html/rfc7519#section-4.1.4)
    
       o  Claim Name: "nbf"
       o  Claim Description: Not Before
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.5 of RFC 7519](/doc/html/rfc7519#section-4.1.5)
    
       o  Claim Name: "iat"
       o  Claim Description: Issued At
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.6 of RFC 7519](/doc/html/rfc7519#section-4.1.6)
    
       o  Claim Name: "jti"
       o  Claim Description: JWT ID
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.7 of RFC 7519](/doc/html/rfc7519#section-4.1.7)
    ...
    10.2.1.  Registry Contents
       ...
       [[RFC6755](/doc/html/rfc6755 ""An IETF URN Sub-Namespace for OAuth"")], which can be used to indicate that the content is a JWT.
    
       o  URN: urn:ietf:params:oauth:token-type:jwt
       o  Common Name: JSON Web Token (JWT) Token Type
       o  Change Controller: IESG
       o  Specification Document(s): [RFC 7519](/doc/html/rfc7519)
...
* * *
    ...
    10.3.1.  Registry Contents
       ...
       This section registers the "application/jwt" media type [[RFC2046](/doc/html/rfc2046 ""Multipurpose Internet Mail Extensions \(MIME\) Part Two: Media Types"")] in
       the "Media Types" registry [IANA.MediaTypes] in the manner described
       in [RFC 6838](/doc/html/rfc6838) [[RFC6838](/doc/html/rfc6838 ""Media Type Specifications and Registration Procedures"")], which can be used to indicate that the content
       is a JWT.
       ...
       o  Security considerations: See the Security Considerations section
          of [RFC 7519](/doc/html/rfc7519)
       o  Interoperability considerations: n/a
       o  Published specification: [RFC 7519](/doc/html/rfc7519)
...
* * *
    ...
    13.1.  Normative References
       ...
       [JWA]      Jones, M., "JSON Web Algorithms (JWA)", [RFC 7518](/doc/html/rfc7518),
                  DOI 10.17487/RFC7518, May 2015,
                  <<http://www.rfc-editor.org/info/rfc7518>>.
    
       [JWE]      Jones, M. and J. Hildebrand, "JSON Web Encryption (JWE)",
                  [RFC 7516](/doc/html/rfc7516),  DOI 10.17487/RFC7516, May 2015,
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       [JWS]      Jones, M., Bradley, J., and N. Sakimura, "JSON Web
                  Signature (JWS)", [RFC 7515](/doc/html/rfc7515), DOI 10.17487/RFC, May 2015,
       ...
       [RFC4949]  Shirey, R., "Internet Security Glossary, Version 2",
                  FYI 36, [RFC 4949](/doc/html/rfc4949), DOI 10.17487/RFC4949, August 2007,
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       [RFC3275]  Eastlake 3rd, D., Reagle, J., and D. Solo, "(Extensible
                  ...
                  [RFC 3275](/doc/html/rfc3275), DOI 10.17487/RFC3275, March 2002,
       ...
       [RFC6755]  Campbell, B. and H. Tschofenig, "An IETF URN Sub-Namespace
                  for OAuth", [RFC 6755](/doc/html/rfc6755), DOI 10.17487/RFC6755, October 2012,
...
* * *
    ...
    [RFC 7519](/doc/html/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       The plaintext used is the octets of the ASCII [[RFC20](/doc/html/rfc20 ""ASCII format for Network Interchange"")] representation
...
* * *
    ...
    Appendix B.  Relationship of JWTs to SAML Assertions
       ...
       [W3C.CR-xml11-20060816] and XML Digital Signature (DSIG) [[RFC3275](/doc/html/rfc3275 ""\(Extensible Markup Language\) XML-Signature Syntax and Processing"")]
       ...
       using the JSON [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")] object encoding syntax.  It also supports
