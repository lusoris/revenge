...
[Home](/docs "Home")[User Guides](/docs/user-guides "User Guides")Workspace Management
...
A developer creates a workspace from a [shared template](/docs/admin/templates). This lets an entire team work in environments that are identically configured and provisioned with the same resources.
...
Bulk operations are a Premium feature. [Learn more](https://coder.com/pricing#compare-plans).
...
Coder might also stop a workspace automatically if there is a [template update](/docs/admin/templates/managing-templates#updating-templates) available.

Learn more about [workspace lifecycle](/docs/user-guides/workspace-lifecycle) and our [scheduling features](/docs/user-guides/workspace-scheduling).

## Workspace resources

Workspaces in Coder are started and stopped, often based on whether there was any activity or if there was a [template update](/docs/admin/templates) available.
