...
> Fetched: 2026-01-30T23:56:40.208639+00:00
> Content-Hash: 4fe04c6f20bf2960
> Type: html
...
This technical manual is intended for developers and technical contributors, and may be difficult for general MediaWiki readers to understand.  For general guidance on using MediaWiki, refer to the
...
This page provides an overview of the MediaWiki
...
endpoint.
For an overview of other APIs exposed by MediaWiki, see
...
All Wikimedia wikis have an MediaWiki Action API endpoint that follow this pattern:
...
To find the endpoint URLs of the APIs exposed by a given wiki, see section

Entry point URLs

on that wiki's Special:Version page.

Introduction

The MediaWiki Action API is a

web service

that allows access to some wiki features like authentication, page operations, and search.
It can provide
...
Create or update a focus area in the Community Wishlist.
...
Support a wish or focus area in the Community Wishlist.
...
For the REST API included with MediaWiki 1.35 and later, see
...
For commercial-scale APIs for Wikimedia projects, see
...
https://www.mediawiki.org/w/index.php?title=API:Action_API&oldid=8157426
