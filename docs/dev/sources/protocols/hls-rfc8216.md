...
> Fetched: 2026-02-01T11:46:20.177418+00:00
...
* * *
    ...
    2.  Overview
       ...
       Identifier (URI) [[RFC3986](/doc/html/rfc3986 ""Uniform Resource Identifier \(URI\): Generic Syntax"")] to a Playlist.
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       any added segments.  Data SHOULD be carried over HTTP [[RFC7230](/doc/html/rfc7230 ""Hypertext Transfer Protocol \(HTTP/1.1\): Message Syntax and Routing"")], but,
...
* * *
    ...
    4.1.  Definition of a Playlist
       ...
       Playlist files MUST be encoded in UTF-8 [[RFC3629](/doc/html/rfc3629 ""UTF-8, a transformation format of ISO 10646"")].  They MUST NOT
...
* * *
    ...
    4.3.2.4.  EXT-X-KEY
       ...
       The following attributes are defined:
          ...
          Public-Key Cryptography Standards #7 (PKCS7) padding [[RFC5652](/doc/html/rfc5652 ""Cryptographic Message Syntax \(CMS\)"")].
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
          ...
          for Identifying Languages [[RFC5646](/doc/html/rfc5646 ""Tags for Identifying Languages"")], which identifies the primary
          language used in the Rendition.  This attribute is OPTIONAL.
    
          ASSOC-LANGUAGE
    
          The value is a quoted-string containing a language tag [[RFC5646](/doc/html/rfc5646 ""Tags for Identifying Languages"")]
...
* * *
    ...
    4.3.4.1.1.  Rendition Groups
       ...
       o  Each EXT-X-MEDIA tag with an AUTOSELECT=YES attribute SHOULD have
          a combination of LANGUAGE [[RFC5646](/doc/html/rfc5646 ""Tags for Identifying Languages"")], ASSOC-LANGUAGE, FORCED, and
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
          ...
          Parameters for "Bucket" Media Types" [[RFC6381](/doc/html/rfc6381 ""The 'Codecs' and 'Profiles' Parameters for "")].
...
* * *
    ...
    4.3.4.4.  EXT-X-SESSION-DATA
       ...
       The following attributes are defined:
          ...
          identified by the URI MUST be formatted as JSON [[RFC7159](/doc/html/rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")];
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       AES-128 CBC with PKCS7 padding [[RFC5652](/doc/html/rfc5652 ""Cryptographic Message Syntax \(CMS\)"")].  Encryption MAY be
    ...
    6.2.4.  Providing Variant Streams
       ...
       format [[RFC6381](/doc/html/rfc6381 ""The 'Codecs' and 'Profiles' Parameters for "")] present in any Media Segment in any of the
...
* * *
    ...
    9.  IANA Considerations
       ...
       IANA has registered the following media type [[RFC2046](/doc/html/rfc2046 ""Multipurpose Internet Mail Extensions \(MIME\) Part Two: Media Types"")]:
...
* * *
    ...
    10.  Security Considerations
       ...
       [[RFC7230](/doc/html/rfc7230 ""Hypertext Transfer Protocol \(HTTP/1.1\): Message Syntax and Routing"")].
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       Mechanism" [[RFC6265](/doc/html/rfc6265 ""HTTP State Management Mechanism"")] to protect themselves from attack.  See also the
       Security Considerations section of that document, and "Use of HTTP
       State Management" [[RFC2964](/doc/html/rfc2964 ""Use of HTTP State Management"")].
    
       Encryption keys are specified by URI.  The delivery of these keys
       SHOULD be secured by a mechanism such as HTTP Over TLS [[RFC2818](/doc/html/rfc2818 ""HTTP Over TLS"")]
    ...
    11.1.  Normative References
       ...
       [AC_3]     Advanced Television Systems Committee, "Digital Audio
                  ...
                  Standard A/52:2010, November 2010, <[http://atsc.org/](http://atsc.org/wp-content/uploads/2015/03/A52-201212-17.pdf)
                  [wp-content/uploads/2015/03/A52-201212-17.pdf](http://atsc.org/wp-content/uploads/2015/03/A52-201212-17.pdf)>.
       ...
       [CEA708]   Consumer Technology Association, "Digital Television (DTV)
                  ...
                  2013, <[https://standards.cta.tech/kwspub/published_docs/](https://standards.cta.tech/kwspub/published_docs/ANSI-CTA-708-E-Preview.pdf)
                  [ANSI-CTA-708-E-Preview.pdf](https://standards.cta.tech/kwspub/published_docs/ANSI-CTA-708-E-Preview.pdf)>.
       ...
       [COMMON_ENC]
                  ...
                  <[http://www.iso.org/iso/](http://www.iso.org/iso/catalogue_detail.htm?csnumber=68042)
                  [catalogue_detail.htm?csnumber=68042](http://www.iso.org/iso/catalogue_detail.htm?csnumber=68042)>.
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       [HDCP]     Digital Content Protection LLC, "High-bandwidth Digital
                  ...
                  February 2013, <[http://www.digital-cp.com/](http://www.digital-cp.com/sites/default/files/specifications/HDCP%20on%20HDMI%20Specification%20Rev2_2_Final1.pdf)
                  [sites/default/files/specifications/](http://www.digital-cp.com/sites/default/files/specifications/HDCP%20on%20HDMI%20Specification%20Rev2_2_Final1.pdf)
                  [HDCP%20on%20HDMI%20Specification%20Rev2_2_Final1.pdf](http://www.digital-cp.com/sites/default/files/specifications/HDCP%20on%20HDMI%20Specification%20Rev2_2_Final1.pdf)>.
       ...
       [ISO_13818_3]
                  ...
                  Audio", April 1998,
                  <[http://www.iso.org/iso/home/store/catalogue_tc/](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=26797)
                  [catalogue_detail.htm?csnumber=26797](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=26797)>.
       ...
       [ISO_13818_7]
                  ...
                  <[http://www.iso.org/iso/home/store/catalogue_tc/](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=43345)
                  [catalogue_detail.htm?csnumber=43345](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=43345)>.
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       [ISOBMFF]  International Organization for Standardization,
                  ...
                  <[http://www.iso.org/iso/](http://www.iso.org/iso/catalogue_detail.htm?csnumber=68960)
                  [catalogue_detail.htm?csnumber=68960](http://www.iso.org/iso/catalogue_detail.htm?csnumber=68960)>.
       ...
       [RFC2964]  Moore, K. and N. Freed, "Use of HTTP State Management",
                  [BCP 44](/doc/html/bcp44), [RFC 2964](/doc/html/rfc2964), DOI 10.17487/RFC2964, October 2000,
       ...
       [RFC5652]  Housley, R., "Cryptographic Message Syntax (CMS)", STD 70,
                  [RFC 5652](/doc/html/rfc5652), DOI 10.17487/RFC5652, September 2009,
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       [RFC6381]  Gellens, R., Singer, D., and P. Frojdh, "The 'Codecs' and
                  'Profiles' Parameters for "Bucket" Media Types", [RFC 6381](/doc/html/rfc6381),
                  DOI 10.17487/RFC6381, August 2011,
                  <<https://www.rfc-editor.org/info/rfc6381>>.
    
       [RFC7159]  Bray, T., Ed., "The JavaScript Object Notation (JSON) Data
                  Interchange Format", [RFC 7159](/doc/html/rfc7159), DOI 10.17487/RFC7159, March
       ...
       [SCTE35]   Society of Cable Telecommunications Engineers, "Digital
                  ...
                  August 2014, <[http://www.scte.org/documents/pdf/Standards/](http://www.scte.org/documents/pdf/Standards/ANSI_SCTE%2035%202014.pdf)
                  [ANSI_SCTE%2035%202014.pdf](http://www.scte.org/documents/pdf/Standards/ANSI_SCTE%2035%202014.pdf)>.
    ...
    11.2.  Informative References
       ...
       [M3U]      Nullsoft, Inc., "The M3U Playlist format, originally
                  ...
                  <[https://en.wikipedia.org/w/](https://en.wikipedia.org/w/index.php?title=M3U7amp;oldid=786631666)
                  [index.php?title=M3U7amp;oldid=786631666](https://en.wikipedia.org/w/index.php?title=M3U7amp;oldid=786631666)>.
...
* * *
    ...
    [RFC 8216](/doc/html/rfc8216)                   HTTP Live Streaming               August 2017
       ...
       [SampleEnc]
                  ...
                  Streaming",
                  <[https://developer.apple.com/library/ios/documentation/](https://developer.apple.com/library/ios/documentation/AudioVideo/Conceptual/HLS_Sample_Encryption/)
                  [AudioVideo/Conceptual/HLS_Sample_Encryption/](https://developer.apple.com/library/ios/documentation/AudioVideo/Conceptual/HLS_Sample_Encryption/)>.
    
       [UNICODE]  The Unicode Consortium, "The Unicode Standard",
                  <<http://www.unicode.org/versions/latest/>>.
    
       [UTI]      Apple Inc., "Uniform Type Identifier",
                  <[http://developer.apple.com/library/ios/#documentation/](http://developer.apple.com/library/ios/#documentation/general/conceptual/DevPedia-CocoaCore/UniformTypeIdentifier.html)
                  [general/conceptual/DevPedia-CocoaCore/](http://developer.apple.com/library/ios/#documentation/general/conceptual/DevPedia-CocoaCore/UniformTypeIdentifier.html)
                  [UniformTypeIdentifier.html](http://developer.apple.com/library/ios/#documentation/general/conceptual/DevPedia-CocoaCore/UniformTypeIdentifier.html)>.
