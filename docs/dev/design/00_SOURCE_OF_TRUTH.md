...
| Music | `public` | ✅ Complete | MusicBrainz, Last.fm | Lidarr | [MUSIC_MODULE.md](features/music/MUSIC_MODULE.md) |
| Audiobook | `public` | ✅ Complete | Audnexus, OpenLibrary | Chaptarr | [AUDIOBOOK_MODULE.md](features/audiobook/AUDIOBOOK_MODULE.md) |
| Book | `public` | ✅ Complete | OpenLibrary, Goodreads | Chaptarr | [BOOK_MODULE.md](features/book/BOOK_MODULE.md) |
...
| Comics | `public` | ✅ Complete | ComicVine | - | [COMICS_MODULE.md](features/comics/COMICS_MODULE.md) |
| LiveTV | `public` | ✅ Complete | XMLTV | TVHeadend | [LIVE_TV_DVR.md](features/livetv/LIVE_TV_DVR.md) |
...
| Fingerprint | `internal/service/fingerprint` | `fingerprint.Module` | ✅ Complete | [FINGERPRINT.md](services/FINGERPRINT.md) |
...
| Metadata | `internal/service/metadata` | `metadata.Module` | ✅ Complete | [METADATA.md](services/METADATA.md) |
| Search | `internal/service/search` | `search.Module` | ✅ Complete | [SEARCH.md](services/SEARCH.md) |
...
|---------|---------|-------------|---------|--------|
| Radarr | Movies | v3 | `internal/service/metadata/radarr` | ✅ Complete |
| Sonarr | TV | v3 | `internal/service/metadata/sonarr` | ✅ Complete |
| Lidarr | Music | v1 | `internal/service/metadata/lidarr` | ✅ Complete |
| Whisparr | QAR | v3 | `internal/service/metadata/whisparr` | 🟡 |
| Chaptarr | Books | v1 (Readarr) | `internal/service/metadata/chaptarr` | ✅ Complete |
