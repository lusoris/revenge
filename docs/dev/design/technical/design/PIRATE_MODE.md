...
Pirate mode features:
- **Trigger**: Unlock through achievements, not hidden menu
- **Elements**: Icons, language, sounds, textures, animations
...
|-----------|--------|-------|
| Design | ✅ | Achievement-based easter egg system |
| Sources | ✅ | - |
| Instructions | ✅ | - |
| Code | 🔴 | - |
| Linting | 🔴 | - |
