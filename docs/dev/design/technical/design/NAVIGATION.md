...
- **Sidebar**: Collapsible rail (64px/240px) with module icons
- **Header**: Sticky with search, notifications, user menu
- **Mobile**: Bottom navigation bar with 4 items
...
|-----------|--------|-------|
| Design | ✅ | Navigation patterns from discovery session |
| Sources | ✅ | - |
| Instructions | ✅ | - |
| Code | 🔴 | - |
| Linting | 🔴 | - |
