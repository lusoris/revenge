...
<!-- SOURCES: fx, go-blurhash, ogen, pgx, postgresql-arrays, postgresql-json, radarr-docs, river, sqlc, sqlc-config -->
...
| Linting | 🔴 |  |
| Unit Testing | 🔴 |  |
| Integration Testing | 🔴 |  |**Location**: `internal/content/movie/`
