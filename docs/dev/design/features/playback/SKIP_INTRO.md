...
<!-- SOURCES: chromaprint-acoustid, ffmpeg, ffmpeg-codecs, ffmpeg-formats, go-astiav, go-astiav-docs, river -->
...
| Linting | 🔴 |
| Unit Testing | 🔴 |
| Integration Testing | 🔴 |**Priority**: 🟢 HIGH (Critical Gap - Plex/Jellyfin have this)
