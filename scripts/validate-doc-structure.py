...
Checks each design doc for required sections:
- Title (# heading)
- Description (> blockquote)
- Status table
- Overview section
- Developer Resources link to SOT
- Breadcrumb sections

Usage:
    python scripts/validate-doc-structure.py                    # Check all
    python scripts/validate-doc-structure.py --strict           # Fail on warnings
    python scripts/validate-doc-structure.py --category services  # Check category
"""
