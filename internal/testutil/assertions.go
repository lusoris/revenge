...
func AssertValidUUID(t *testing.T, s string, msgAndArgs ...interface{}) {
	t.Helper()
	_, err := uuid.Parse(s)
...
func RequireValidUUID(t *testing.T, s string, msgAndArgs ...interface{}) {
	t.Helper()
	_, err := uuid.Parse(s)
...
func AssertTimeEqualWithTolerance(t *testing.T, expected, actual time.Time, tolerance time.Duration, msgAndArgs ...interface{}) {
	t.Helper()
...
// Default tolerance is 1 second.
func RequireTimeEqual(t *testing.T, expected, actual time.Time, msgAndArgs ...interface{}) {
	t.Helper()
...
func RequireTimeEqualWithTolerance(t *testing.T, expected, actual time.Time, tolerance time.Duration, msgAndArgs ...interface{}) {
	t.Helper()
	diff := expected.Sub(actual)
	if diff < 0 {
		diff = -diff
...
func AssertRecentTime(t *testing.T, tm time.Time, msgAndArgs ...interface{}) {
	t.Helper()
...
func AssertRecentTimeWithTolerance(t *testing.T, tm time.Time, tolerance time.Duration, msgAndArgs ...interface{}) {
	t.Helper()
	now := time.Now()
	diff := now.Sub(tm)
	assert.GreaterOrEqual(t, diff, time.Duration(0), append([]interface{}{"time should not be in the future"}, msgAndArgs...)...)
	assert.LessOrEqual(t, diff, tolerance, append([]interface{}{"time should be recent"}, msgAndArgs...)...)
}

// RequireRecentTime requires that the given time is recent (within the last minute).
func RequireRecentTime(t *testing.T, tm time.Time, msgAndArgs ...interface{}) {
	t.Helper()
...
func RequireRecentTimeWithTolerance(t *testing.T, tm time.Time, tolerance time.Duration, msgAndArgs ...interface{}) {
	t.Helper()
	now := time.Now()
	diff := now.Sub(tm)
	require.GreaterOrEqual(t, diff, time.Duration(0), append([]interface{}{"time should not be in the future"}, msgAndArgs...)...)
	require.LessOrEqual(t, diff, tolerance, append([]interface{}{"time should be recent"}, msgAndArgs...)...)
}
...
func AssertSliceContains[T comparable](t *testing.T, slice []T, element T, msgAndArgs ...interface{}) {
	t.Helper()
	assert.Contains(t, slice, element, msgAndArgs...)
}

// RequireSliceContains requires that a slice contains the given element.
func RequireSliceContains[T comparable](t *testing.T, slice []T, element T, msgAndArgs ...interface{}) {
	t.Helper()
