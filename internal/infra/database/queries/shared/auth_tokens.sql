...
DELETE FROM shared.auth_tokens WHERE expires_at < NOW();
...
SELECT *
FROM shared.email_verification_tokens
WHERE
    token_hash = $1
...
INSERT INTO
    shared.failed_login_attempts (username, ip_address)
VALUES ($1, $2);
...
DELETE FROM shared.failed_login_attempts WHERE username = $1;
