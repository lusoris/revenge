...
UPDATE tvshow.series SET
    ...
    sonarr_id = COALESCE(sqlc.narg('sonarr_id'), sonarr_id),
    ...
    total_seasons = COALESCE(sqlc.narg('total_seasons'), total_seasons),
    total_episodes = COALESCE(sqlc.narg('total_episodes'), total_episodes),
    trailer_url = COALESCE(sqlc.narg('trailer_url'), trailer_url),
    homepage = COALESCE(sqlc.narg('homepage'), homepage),
